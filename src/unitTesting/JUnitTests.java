...
public class JUnitTests
{
	...
	public void testCopyConstructor()
	{
		...
		assertTrue("Error: not constructed correctly, wrong number of methods",
				copyConstructedNode.getNumMethods() == 2);
	...
	public void testRelationships()
	{
		...
		assertTrue("Error: addRelationship error, relationship not properly stored", node2.getRelationships().get(0)
				.equals(rel.getModel()));

		// Delete node1
		testDiagram.setSelectedObject(node1, true);
		testDiagram.deleteSelectedObjects();
		...
		testDiagram.setSelectedObject(rel2, true);
		testDiagram.deleteSelectedObjects();
	...
	public void testNodeEquality()
	{
		...
		assertFalse("Error: nodes should not be the same because of different names", node1.equals(node2));

		// Setting nodes to have equal names
		node1.setName("hi");
		node2.setName("hi");

		assertTrue("Error: nodes should be the same", node1.equals(node2));

		// Nodes different because of additional attribute
		node1.addAttribute("trib");

		assertFalse("Error: node1 should have another attribute", node1.equals(node2));
